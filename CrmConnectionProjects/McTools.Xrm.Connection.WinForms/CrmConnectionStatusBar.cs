...
namespace McTools.Xrm.Connection.WinForms
{
    ...
    public partial class CrmConnectionStatusBar : StatusStrip
    {
        ...
        private void AddActionsList(ToolStripDropDownButton btn)
        {
            ...
            if (cManager != null && cManager.ConnectionsList != null && cManager.ConnectionsList.Connections.Count > 0)
            {
                cManager.ConnectionsList.Connections.Sort();

                foreach (ConnectionDetail cDetail in cManager.ConnectionsList.Connections)
                {
                ...
                if (cManager.ConnectionsList.Connections.Count > 0)
                {
        ...
        {
            ToolStripLabel label = (ToolStripLabel)Items[1];
        ...
        void newConnectionItem_Click(object sender, EventArgs e)
        {
            ...
            if (detail != null)
            {
                ...
                ToolStripDropDownButton connexionManager = (ToolStripDropDownButton)Items[0];
        ...
        void actionItem_Click(object sender, EventArgs e)
        {
            ...
            {
                case "Connect":
                    cManager.ConnectToServer(currentConnection);
                    break;
                case "Edit":
