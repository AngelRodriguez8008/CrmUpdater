...
namespace McTools.Xrm.Connection.WinForms
{
    ...
    public partial class ConnectionForm : Form
    {
        ...
        /// </summary>
        public bool DoConnect => doConnect;
        ...
        private void BValidateClick(object sender, EventArgs e)
        {
            ...
            if (selectedOrganization != null)
            {
                ...
                detail.OrganizationId = selectedOrganization.OrganizationId;
            }
            ...
            if (selectedSolution != null)
            {
                ...
                detail.SolutionId = selectedSolution.SolutionId;
        ...
        private bool FillConnectionDetails()
        {
            ...
            if (tbServerPort.Text.Length > 0)
            {
                if (!int.TryParse(tbServerPort.Text, out serverPort))
                {
                    MessageBox.Show(this, "Server port must be a integer value!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return false;
                }
            }
        ...
        private void BGetSolutionsClick(object sender, EventArgs e)
        {
            if (FillConnectionDetails())
            {
                ...
                detail.OrganizationId = organizationDetail.OrganizationId;
        ...
        private object RetrieveOrganization(ConnectionDetail currentDetail)
        {
            ...
            DiscoveryServiceProxy service = CrmConnectionHelper.GetDiscoveryService(currentDetail);
            
            OrganizationDetail result = service.GetOrganization(currentDetail.OrganizationId.Value);
            return result;
        }
        ...
        private Entity RetrieveSolution(ConnectionDetail currentDetail)
        {
            ...
            OrganizationServiceProxy service = CrmConnectionHelper.GetOrganizationServiceProxy(currentDetail);

            var result = service.GetSolution(currentDetail.SolutionId.Value);
            return result;
        }
        ...
        private void FillDetails()
        {
            ...
            OrganizationDetail selectedOrganization = ((Organization) comboBoxOrganizations.SelectedItem)?.OrganizationDetail;
            if (selectedOrganization == null)
                throw new Exception("There is not organization selected");
            ...
            foreach (OrganizationDetail organization in organizations)
            {
                if (organization.UniqueName == selectedOrganization.UniqueName)
                {
                    ...
                    detail.OrganizationId = organization.OrganizationId;
